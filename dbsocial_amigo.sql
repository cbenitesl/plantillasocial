...
CREATE TABLE `amigo` (
  `ami_correo` varchar(45) NOT NULL,
  `ami_amigo` varchar(45) NOT NULL
...
INSERT INTO `amigo` VALUES ('dx@hotmail.com','eruizp@hotmail.com'),('darwin@hotmail.com','eruizp@hotmail.com'),('darwin@hotmail.com','dx@hotmail.com'),('darwin@hotmail.com','ebenites@hotmail.com'),('eruizp@hotmail.com','ebenites@hotmail.com');
